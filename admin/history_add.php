...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    ...
    <form id="myform1" name="form1" method="POST" action="history_add_db.php" novalidate>
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="col-lg-8 offset-lg-2">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-8">
                    ...
                    <input type="text" name="topic" id="topic" class="form-control" placeholder="หัวเรื่อง" required>
                  </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-lg-12 ">
                    ...
                    <input type="text" name="detail" id="detail" class="form-control" placeholder="รายละเอียด" required>
                  </div>
