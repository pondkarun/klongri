...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    ...
    <div class="app-title">
      ...
      <a href="activities_add.php?active=activities" class="btn btn-primary">เพิ่มกิจกรรม</a>
    </div>
                  ...
                  <tbody>
                    ...
                    <?php while ($row = mysqli_fetch_array($result)) {  ?>
                      <tr>
                        ...
                        <td align="center">
                          <div class="row">
                            <a href="activities_edit.php?id_activities=<?php echo $row[id]; ?>&active=activities" class="col btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
  ...
  <script type="text/javascript">
    ...
    function myFunction(key) {
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            window.location = 'activities_del_db.php?id_activities=' + key;
          }
        });
    }
  </script>
