...
$sql = "SELECT * FROM activities WHERE id = $id_activities";
...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    ...
    <form id="myform1" name="form1" method="POST" action="activities_edit_db.php" novalidate enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile-footer text-center">
              <div class="row">
                ...
                <div class="col-md-12 ">
                  ...
                  <input type="hidden" name="id_activities" value="<?php echo $id_activities ?>">
